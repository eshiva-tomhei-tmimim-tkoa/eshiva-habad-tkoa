// Набор иконок дизайн-системы (контурные SVG, наследуют currentColor).
// Соответствует эталону Yeshiva-ChaBaD-Tkoa.html.
...
export const Icon = {
  ...
  book: (p: P) => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <path d="M4 5a2 2 0 0 1 2-2h14v18H6a2 2 0 0 1-2-2zM4 5v14" />
    </svg>
  ),
  calendar: (p: P) => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
